  ...
  <head>
	...
	<body>
        ...
        <div class="navbar">    
          ...
          <p>
            Ingrese el grado académico del profesor, usando la siguiente nomenclatura: 
            Licenciatura (LIC), Especialización (ESP), Maestría (MAE), Doctorado (DOC), Otro (OTR) (especificar).
          </p>
          <hr>
